...
export class AdminPanelComponent implements OnInit {
  ...
  status: string[] = ['Infringir', 'Espera', 'Baneado', 'Rechazado', 'Aceptado', 'Todos'];
  ...
  filteredstatus: Observable<any[]> = of([]);
  controlCambios = new FormControl();

  constructor(private blog: FormBuilder, private route: Router, private homeService: HomeService, private loginService: LoginService, public dialog: MatDialog) {
  ...
  ngOnInit() {
    ...
    this.form.valueChanges.subscribe((values) => {
      ...
      this.forMe = this._filterStatus(values.status);
    });
    ...
    this.filteredstatus = this.controlCambios.valueChanges.pipe(
      startWith(''),
